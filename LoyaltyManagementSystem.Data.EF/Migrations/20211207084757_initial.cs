        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    OrganizerName = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    OrganizerPhone = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Permisions_AppRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AppRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Permisions_Functions_FunctionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CollectionId = table.Column<int>(type: "int", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CampaignDetails_Collections_CollectionId",
                        column: x => x.CollectionId,
                        principalTable: "Collections",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CampaignDetails_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CampaignDetails_Stores_StoreId",
                        column: x => x.StoreId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CollectionDetails_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CollectionDetails_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Gift = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    DayOfRedemption = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateModified = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Addresss = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CampaignDetails_CollectionId",
                table: "CampaignDetails",
                column: "CollectionId");

            migrationBuilder.CreateIndex(
                name: "IX_CampaignDetails_ProductId",
                table: "CampaignDetails",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_CampaignDetails_StoreId",
                table: "CampaignDetails",
                column: "StoreId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CollectionDetails_ProductId",
                table: "CollectionDetails",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_CollectionDetails_StoreId",
                table: "CollectionDetails",
                column: "StoreId");
